...
<head>
    ...
    <style>
        .video-container {
            position: relative;
            padding-bottom: 50%; /* Aspek rasio 1:2 (50%) untuk video */
            height: 0;
            overflow: hidden;
        }
   ...
   <div class="modal fade" id="simpan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                                 ...
                                 <div class="input-group">
                                     <input type="text" class="form-control bg-light border-0 small" placeholder="Cari Podcast"
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        @endif
                            ...
                            <div class="row">
                            @foreach ($tiketcs as $cs)
                              
                            
                                <!-- Column for the first card -->
                                <div class="col-lg-6 order-lg-2">
                                    <!-- Blog post-->
                                    <div class="card mb-4">
                                        <div class="video-container">
                                            <iframe id="videoFrame" src="/image/{{$cs->Foto}}" sandbox="" allowfullscreen></iframe>
                                            <button id="playButton">Play</button>
                                        </div>
                                        <div class="card-body">
                                            <div class="small text-muted">{{ $cs->created_at->format('d-m-Y')}}</div>
                                            <h2 class="card-title h4">{{$cs->Judul}}</h2>
                                            <p class="card-title h4">{{$cs->Genre}}</p>
                                            {{-- <a href="{{url('/lihat',$cs->id)}}" class="btn btn-secondary">View</a> --}}
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <!-- Column for the second and third cards -->
    ...
    <script>
        ...
        playButton.addEventListener('click', function() {
            videoFrame.src = "/image/{{$cs->foto}}";
            videoFrame.setAttribute('allowfullscreen', '');
            videoFrame.setAttribute('autoplay', '0');
            videoFrame.play();
